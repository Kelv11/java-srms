...
public class AdminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Form 4", "Form 3", "Form 2", "Form 1" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String AdmNumber=jTextField2.getText();
        String StdClass=(String) jComboBox1.getSelectedItem();
        ...
        try{
            ...
            st.executeUpdate("insert into student(stdName,AdmNo,class,Gender,GuardianName)values('"+studentName+"','"+AdmNumber+"','"+StdClass+"','"+Gender+"','"+GuardianName+"')");
        ...
        {
            JOptionPane.showMessageDialog(null,"This Adm Number already exists");
